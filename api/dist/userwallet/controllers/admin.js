...
var _createuserwallet = _interopRequireDefault(require("../utilities/createuserwallet"));
...
var userwalletadmin = _express["default"].Router();
userwalletadmin.put('/userwallet/updatebalance/', _authenticateToken["default"], /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$query, walletid, assetid, balance, userwallet, asset, balances, assetbalance, assetbalances, asset_balance, _asset_balance;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _req$query = req.query, walletid = _req$query.walletid, assetid = _req$query.assetid;
          ...
          res.status(500).send({
            error: 'there must be a balance, assetid, and walletid present'
          });
...
userwalletadmin.put('/userwallet/updatebtcaddress/', _authenticateToken["default"], /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var walletid, bitcoinaddress, userwallet;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          res.status(500).send({
            error: 'there must be a bitcoinaddress and walletid present'
          });
        ...
        case 17:
          res.status(404).send({
            error: 'no such wallet found for user'
          });
        case 18:
          _context2.next = 24;
          break;
        case 20:
          ...
          res.status(500).send({
            error: 'error updating wallet bitcoin address'
          });
        case 24:
        case "end":
...
userwalletadmin.post('/userwallet/create/', _authenticateToken["default"], /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 6:
          _context3.next = 8;
          return (0, _createuserwallet["default"])(userid);
        case 8:
          res.status(200).send({
...
userwalletadmin.get('/userwallet/getwithdrawal/requests', _authenticateToken["default"], /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var walletid, withdrawrequests;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          walletid = req.query.walletid;
          _context4.next = 5;
          return _withdrawalrequest["default"].find({
            walletid: walletid
          });
        case 5:
          withdrawrequests = _context4.sent;
          res.status(200).send({
...
userwalletadmin.post('/userwallet/transaction/create', _authenticateToken["default"], /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var userid, newtransaction;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 1;
          userid = req.query.userid;
          newtransaction = new _transaction["default"](_objectSpread({
            userid: userid
          }, req.body));
          _context5.next = 6;
